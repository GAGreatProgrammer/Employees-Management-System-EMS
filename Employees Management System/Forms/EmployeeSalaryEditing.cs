...
{
    public partial class EmployeeSalaryEditing : Form
    {
        private SqlConnection sqlConnection = null;

        int PayFrequency;

        public EmployeeSalaryEditing()
        {
            InitializeComponent();
        ...
        private void Editing()
        {
            ...
            try
            {
                SqlCommand sqlCommand = new SqlCommand("EditingEmployeeSalary", sqlConnection);
                ...
                MessageBox.Show($"თანამშრომლის ხელფასი რედაქტირებულია", "თანამშრომლის ხელფასი", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void EmployeeSalaryEditing_Load(object sender, EventArgs e)
        {
